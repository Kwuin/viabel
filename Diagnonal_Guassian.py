...
def diagonal_gaussian(D, mean, stdev):
    def log_gaussian(x):
        if x.ndim == 1:
            x = x[np.newaxis, :]
    ...
    init_var_param = np.concatenate([10 * mean, 10 * mean])
    approx = MFGaussian(D)
    ...
    info = "diagonal_gaussian_heteromean_heterovar"
    ...
    for i in range(1):
        ...
        plt.title("elbo history of" + str(D) + " dimension with heterogeneous mean")
        ...
        plt.title("variational parameter history of RGE" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("variational parameter history of exKL" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("variational parameter history of KL" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("mean grad history of KL" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("mean grad history of RGE" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("log scale grad history of KL" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
        ...
        plt.title("log scale grad history of RGE" + str(D) + " dimension with heterogeneous mean")
        plt.legend(loc=2, prop={'size': 6})
    ...
    file.write("average varaince reduction" + str(var_reduction_record))
    file.close()
...
# stdev = np.arange(1, D + 1)
stdev = 5 * np.ones(D)

diagonal_gaussian(D, mean, stdev)
